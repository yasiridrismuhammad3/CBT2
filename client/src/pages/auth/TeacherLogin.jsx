...
import { UserCheck, Lock, Mail, AlertCircle, ArrowLeft } from 'lucide-react';
import { motion } from 'framer-motion';

const TeacherLogin = () => {
  const [email, setEmail] = useState('teacher@damale.edu.ng');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Login failed. Invalid teacher credentials.');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-damale-navy-900 via-slate-900 to-damale-navy-800 text-slate-100">
      ...
      >
        ...
        <div className="text-center mt-4 mb-8">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-damale-navy-600 mx-auto flex items-center justify-center text-white mb-4 shadow-lg shadow-blue-500/30 ring-4 ring-blue-400/30">
            <UserCheck className="w-8 h-8" />
          </div>
          <h2 className="text-2xl font-extrabold text-white uppercase tracking-tight">Teacher Portal Login</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                required
                placeholder="teacher@damale.edu.ng"
                value={email}
